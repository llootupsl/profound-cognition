...
用途: 跨平台可视化 profound-cognition 的 57 节点 DAG 执行流程
作者: 阿洋
版本: 5.1.0
日期: 2026-06-17
================================================================================
...
# ----------------------------------------------------------------------------
# 57 节点 DAG 拓扑定义（与 SKILL.md SSOT 严格对齐）
# 格式: (node_id, phase, 中文名称, 类型)
# 类型: node / gate / hard_gate
# 节点总数: 57（Phase1=15 + Phase2=9 + Phase3=8 + Phase4=6 + Phase7=19）
...
def generate_mermaid_dag():
    ...
    lines = [
        "```mermaid",
        "graph TD",
        "    %% Profound Cognition 57-Node DAG Topology v5.1.0",
