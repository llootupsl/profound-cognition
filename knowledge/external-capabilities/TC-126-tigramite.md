...
- **版本要求**: >=5.0
- **许可证**: GPL-3.0
- **仓库**: https://github.com/jakobrunge/tigramite
- **维护方**: tigramite

## 核心能力
- 时序因果发现（PCMCI/PCMCI+/LPCMCI 算法）
- 条件独立性检验（ParCorr/GPDC/CMIknn）
- 支持非线性因果检测
- 适合气候/神经科学/金融时序数据

## 在 profound-cognition 中的用途
- **TM02 因果验证**: TM02 因果验证节点时序因果发现备选
- **状态**: 提级（已补建独立卡）
- **内化位置**: requirements.txt 依赖声明 + SKILL.md:1215 提及
...
## 替代关系
- **可被替代为**: causal-learn（TC-086，通用因果发现）+ dodiscover（TC-116，实验性因果发现）
- **替代说明**: 见能力卡注册表
