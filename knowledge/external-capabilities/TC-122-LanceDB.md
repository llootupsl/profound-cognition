...
> - maintainer: 阿洋
> - changelog:
>   - v1.0 初始版本（Wave 4 Step 4 补建，对应 v5.1.0 报告第四章 4.4.9 项）

# TC-122: LanceDB — 向量数据库
...
- **Qdrant 备选**: Qdrant 插件备选；当前主路径使用 Qdrant 插件，LanceDB 作为嵌入式轻量级备选待激活
- **状态**: 待激活
...
## 替代关系
- **可被替代为**: Qdrant 插件
- **替代说明**: 见 v5.1.0 报告第四章 4.4.9 节融入方案
