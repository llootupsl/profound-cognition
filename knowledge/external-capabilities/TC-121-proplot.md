...
> - maintainer: 阿洋
> - changelog:
>   - v1.0 初始版本（Wave 4 Step 4 补建，对应 v5.1.0 报告第四章 4.4.8 项）
...
- **版本要求**: >=0.1
- **许可证**: MIT
- **仓库**: https://github.com/proplot-dev/proplot
- **维护方**: proplot-dev

## 核心能力
- matplotlib 高级封装（更简洁 API）
- 支持复杂子图布局
- 美化默认样式

## 在 profound-cognition 中的用途
- **matplotlib 高级封装**: T27 可视化备选；当前主路径使用 matplotlib + SciencePlots（4.3.13），proplot 作为高级封装备选待激活
- **状态**: 待激活
...
## 替代关系
- **可被替代为**: matplotlib + SciencePlots（4.3.13）
- **替代说明**: 见 v5.1.0 报告第四章 4.4.8 节融入方案
