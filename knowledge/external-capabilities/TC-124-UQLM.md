...
> - maintainer: 阿洋
> - changelog:
>   - v1.0 初始版本（Wave 4 Step 4 补建，对应 v5.1.0 报告第四章 4.4.11 项）
...
- **置信度校准**: MAPIE（A.3）备选；当前主路径使用 MAPIE 进行不确定性量化，UQLM 作为 LLM 专用 UQ 工具待激活
- **状态**: 待激活
...
## 替代关系
- **可被替代为**: MAPIE（A.3）
- **替代说明**: 见 v5.1.0 报告第四章 4.4.11 节融入方案

## Audit-6 Wave 4 备注
- **核验状态**: ❌缺失 → ✅已补建（Wave 4 Step 4 - W4-F1）
- **对应 v5.1.0 报告项**: 4.4.11
- **核验日期**: 2026-06-27
- **审计员**: 独立审计子代理（Audit-6）
