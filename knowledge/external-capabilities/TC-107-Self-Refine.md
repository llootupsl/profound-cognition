...
> - maintainer: 阿洋
> - changelog:
>   - v1.0 初始版本（Wave 4 Step 4 补建，对应 v5.1.0 报告第四章 4.3.8 项）

# TC-107: Self-Refine — 认知综合
...
- **版本要求**: >=0.1
- **许可证**: MIT
- **仓库**: https://github.com/microsoft/selfrefine
- **维护方**: selfrefine
...
- **T13 认知综合**: T13 认知综合节点备选；当前主路径使用 TM05 元认知反思 + T12b 三路对抗验证，Self-Refine 作为轻量级自我精炼方案待激活
- **状态**: 待激活
...
## 替代关系
- **可被替代为**: TM05 元认知反思 + T12b 三路对抗验证
- **替代说明**: 见 v5.1.0 报告第四章 4.3.8 节融入方案
