...
> - maintainer: 阿洋
> - changelog:
>   - v1.0 初始版本（Wave 4 Step 4 补建，对应 v5.1.0 报告第四章 4.4.1 项）

# TC-114: OpenResearcher — 深度研究
...
- **版本要求**: >=0.1
- **许可证**: MIT
- **仓库**: https://github.com/FacebookResearch/OpenResearcher
...
- **T02 备选（实验性）**: T02 备选；反响待验证（4.5 实验性项目），作为 GPT-Researcher 的开源备选方案保留实验性集成
- **状态**: 实验性
...
## 替代关系
- **可被替代为**: GPT-Researcher（TC-030）
- **替代说明**: 见 v5.1.0 报告第四章 4.4.1 节融入方案
