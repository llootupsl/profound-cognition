...
> - maintainer: 阿洋
> - changelog:
>   - v1.0 初始版本（Wave 4 Step 4 补建，对应 v5.1.0 报告第四章 4.3.4 项）

# TC-106: RAGFlow — RAG 引擎
...
## 核心能力
- 深度文档理解 RAG（含 OCR/表格/布局分析）
- 混合检索（向量+关键词+知识图谱）
- 可复现的引用追溯

## 在 profound-cognition 中的用途
- **T02 备选**: T02 检索增强生成备选；当前主路径使用 GPT-Researcher + Crawl4AI + SearXNG 组合，RAGFlow 作为深度文档解析 RAG 备选待激活
- **状态**: 待激活
...
## 替代关系
- **可被替代为**: GPT-Researcher + Crawl4AI + SearXNG 组合
- **替代说明**: 见 v5.1.0 报告第四章 4.3.4 节融入方案
