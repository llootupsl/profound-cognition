...
> - maintainer: 阿洋
> - changelog:
>   - v1.0 初始版本（Wave 4 Step 4 补建，对应 v5.1.0 报告第四章 4.4.4 项）
...
## 核心能力
- 角色扮演式多智能体编排（Crew + Agent + Task）
- 支持顺序/层次化任务分配
- 与 LangChain 生态兼容

## 在 profound-cognition 中的用途
- **LangGraph 备选**: LangGraph（TC-100）备选；当前主路径使用 LangGraph DAG 原生编排，CrewAI 作为角色扮演式备选待激活
- **状态**: 待激活
...
- **替代说明**: 见 v5.1.0 报告第四章 4.4.4 节融入方案
