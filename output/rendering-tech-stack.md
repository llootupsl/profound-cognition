...
| 图类型 | 首选工具 | 穷尽重试工具 | 适配器文件 |
|--------|---------|---------|-----------|
| 框架图 / 概念图 | 内联 Mermaid/SVG 图生成（手绘SVG） | Mermaid.js | `plugins/paper-figure-adapter.md` |
| 概念插图 | Qwen-Image（文生图） | 占位图 + alt 文本 | `plugins/qwen-image-adapter.md` |
| 数据图表 | Observable Plot + ECharts | ASCII 表格 | `output/chart-renderer.md` |
| 思维导图 | Markmap | 缩进列表 | `output/mindmap-renderer.md` |
